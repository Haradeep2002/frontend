            ...
            {products &&
                <div className={`${classes.main}`}>
                    ...
                    <span className={classes.image}>
                        <img className={` ${classes.mydiv}`} src={`${API}/product/photo/${products[myIndex]._id}`} style={{ height: '550px', cursor: 'pointer' }} onClick={clickHandle} /><i class="fa fa-search fa-3x" />
                    </span>
